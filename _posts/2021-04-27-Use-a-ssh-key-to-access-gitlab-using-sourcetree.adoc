...
+
NOTE: If you are using Two-factor Authentication on your GitLab.com account, read https://www.jaredleonmorgan.net/use-a-ssh-key-to-access-gitlab-using-sourcetree/[my April 2021 blog post about SourceTree and GitLab.com] for help with creating a personal access token. 
