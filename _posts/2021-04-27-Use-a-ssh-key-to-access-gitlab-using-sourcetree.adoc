...
*  https://www.jaredleonmorgan.net/use-a-ssh-key-to-access-gitlab-using-sourcetree/[Use a personal access token] to access GitLab.com over HTTPS.
...
+
NOTE: If you are using Two-factor Authentication on your GitLab.com account, read link:../#/2021-04-28-Use-a-personal-access-token-to-access-gitlab-using-sourcetree.adoc[my April 2021 blog post about SourceTree and GitLab.com] for help with creating a personal access token. 
