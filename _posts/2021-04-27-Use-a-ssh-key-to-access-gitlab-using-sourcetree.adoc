...
+
NOTE: If you are using Two-factor Authentication on your GitLab.com account, read link:../Use-a-personal-access-token-to-access-gitlab-using-sourcetree[my April 2021 blog post about SourceTree and GitLab.com] for help with creating a personal access token. 
