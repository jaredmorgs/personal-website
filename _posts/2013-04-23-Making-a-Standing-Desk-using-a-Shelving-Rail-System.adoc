---
layout: post
title:  "Make a standing desk using a shelving rail system"
categories: [Workarounds]
tags: [diy, budget, desk, shelving]
image: assets/images/covers/ideas.jpg
description: "Build a fixed and adjustable standing desk using shelving materials and save heaps!"
#featured: true
#hidden: true
#rating: 4.5
---
...
You can make a standing desk out of shelving rails and brackets, and some MDF board. 
It really doesn't have to be expensive or difficult. 
I built mine for about \$150, but that cost also included paint, and some tools I didn't have. 
See <<basic-costs>> and <<ancilliary-costs>> for further details.
...
** Measure these first. 
Your studs will determine how wide your shelves can be in some scenarios.

** Don't even think about using heavy-duty plasterboard screws for this task. 
They really aren't strong enough.
...
* Get your wood cut at your local big hardware shop. 
They usually do it for free, and unless you have a circular saw and a keen eye, you will get much better results having it done on a cutting station.
...
I took this one step further, and made a forum where staff can record what tools they are willing to loan to other staff members. 
So far, it seems to have had a slow response, but as time goes by I can see it as a great way to have an unofficial tool co-op for everyone to benefit from.
