---
layout: post
title:  "Using SourceTree to access GitLab through SSH"
...
* xref:2021-04-28-Use-a-personal-access-token-to-access-gitlab-using-sourcetree.adoc[Configure a personal access token] to access GitLab.com over HTTPS.
...
When you add a GitLab.com account to SourceTree you can hold down the kbd:[alt] (Windows) or kbd:[opt] (macOS) keys to switch the btn:[Copy to clipboard] button to the btn:[Generate key] function. 
...
Update the remote origin to point to the new GitLab SSH path and you'll be back in business.
