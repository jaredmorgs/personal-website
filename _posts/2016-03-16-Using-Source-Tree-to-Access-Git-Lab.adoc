...
[NOTE]
====
Read xref:2021-04-28-Use-a-personal-access-token-to-access-gitlab-using-sourcetree.adoc[] for updated instructions about setting up SourceTree with GitLab.com account access over HTTPS. 
====
...
=== Add GitLab to SourceTree accounts

You can use GitLab CE, GitLab.com, and GitLab Enterprise in SourceTree as an account type.

For this guide, you will create an account profile in SourceTree for GitLab.com using a private token.

Private tokens let you connect multiple apps (such as multiple SourceTree apps across user profiles).
