...
- Apparently the very coldly-received 2012 https://www.ipdb.org/machine.cgi?id=5861[Transformers The Pin] from Stern was basically "SPIKE Beta". I have a new appreciation for it, but only for the fact it was a beta testing platform. ;)
...
- Debate about the protocol: whether it is https://en.wikipedia.org/wiki/CAN_bus[Controller Area Network] (CAN) or https://en.wikipedia.org/wiki/RS-485[RS-485]
